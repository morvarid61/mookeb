import"./tailwind-DYkSoCjc.js";let c=(...o)=>{o.forEach(e=>{document.querySelector("#root").insertAdjacentHTML("beforeend",e)})},i=` <div class="flax justify-center items-center h-screen ">
        <div>
      ...
      </div>`;const x=()=>{const o=new Date("2025-07-11T00:00:00"),e=document.getElementById("countdown"),n=()=>{const t=o-new Date;if(t<=0){e.textContent="00:00:00:00",clearInterval(s),window.location.href="./test.html";return}const a=Math.floor(t/(1e3*60*60*24)),d=Math.floor(t%(1e3*60*60*24)/(1e3*60*60)),r=Math.floor(t%(1e3*60*60)/(1e3*60)),l=Math.floor(t%(1e3*60)/1e3);e.textContent=String(a).padStart(2,"0")+":"+String(d).padStart(2,"0")+":"+String(r).padStart(2,"0")+":"+String(l).padStart(2,"0")},s=setInterval(n,1e3);n()};c(i);x();
