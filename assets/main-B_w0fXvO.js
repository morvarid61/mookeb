import"./tailwind-DYkSoCjc.js";let c=(...n)=>{n.forEach(e=>{document.querySelector("#root").insertAdjacentHTML("beforeend",e)})},i=` <div class="flax justify-center items-center h-screen ">
        <div>
